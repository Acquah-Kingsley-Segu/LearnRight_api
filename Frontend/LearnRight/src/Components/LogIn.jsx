    ...
    >
      ...
      <form action="" method="post" className="flex-1 flex flex-col">
        <div className="border-b-[1.5px] border-solid border-[#aaaaaa] relative mt-[30px] mx-3 h-[40px] flex justify-center">
          ...
          <input className="w-full h-full outline-none py-0 pl-1 text-[#333] text-sm transition-all duration-[200ms] ease-in-out" type="email" placeholder="Enter your email" required />
        ...
        <div className="border-b-[1.5px] border-solid border-[#aaaaaa] relative mt-[15px] mx-3 h-[40px] flex justify-center">
          ...
          <input className="w-full h-full outline-none py-0 pl-1 text-[#333] text-sm transition-all duration-[200ms] ease-in-out" type="password" placeholder="Enter your password" required />
        ...
        <div className="mt-[14px] bg-greeen-200 mx-3 flex items-center justify-between">
          ...
          <a href="#" className="forgot_pw text-violet-400 text-sm">Forgot password?</a>
        </div>
  
        <button className="py-[6px] px-[24px] mx-3 mt-10 hover:bg-white hover:border-[1.5px] hover:border-violet-700 hover:text-black text-white bg-violet-700 border-[1.5px] border-solid border-[#fff] bg-transparent rounded-[6px] cursor-pointer">Login Now</button>
  
        <div className="text-xs text-center mt-[15px]">
          Don't have an account? <a href="#" id="signup" className="text-violet-400">Signup</a>
        </div>
      </form>
    </ReactModal>
  )
